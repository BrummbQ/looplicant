...
export default function PersonalInputCard({
  form,
}: {
  form: UseFormReturn<ImportFormSchemaType>;
}) {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center space-x-2">
          ...
          <CardTitle>Your Import</CardTitle>
        </div>
        <CardDescription>
          Paste your resume, a detailed summary, or upload your CV as a PDF to
          import your profile
        </CardDescription>
      </CardHeader>
